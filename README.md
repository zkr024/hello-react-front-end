...
## Back-end Repo
[click here](https://github.com/zkr024/hello-rails-back-end)
...
- SSH: https://github.com/zkr024/hello-react-front-end.git
- From the folder where all the files are located please Run:
> npm install.
- And to launch the web server, please run:
> npm start.
